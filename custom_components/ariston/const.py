        ...
        extra_states=[
            {
                ...
                EXTRA_STATE_DEVICE_METHOD: lambda entity: entity.device.get_water_heater_temperature_step(),
            }
        ],
...
ARISTON_SENSOR_TYPES: list[AristonSensorEntityDescription] = (
    AristonSensorEntityDescription(
        ...
        get_native_value=lambda entity: entity.device.get_heating_circuit_pressure_value(),
        get_native_unit_of_measurement=lambda entity: entity.device.get_heating_circuit_pressure_unit(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        get_native_value=lambda entity: entity.device.get_ch_flow_setpoint_temp_value(),
        get_native_unit_of_measurement=lambda entity: entity.device.get_ch_flow_setpoint_temp_unit,
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        get_native_value=lambda entity: entity.device.get_ch_flow_temp_value(),
        get_native_unit_of_measurement=lambda entity: entity.device.get_ch_flow_temp_unit(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        get_native_value=lambda entity: entity.device.get_outside_temp_value(),
        get_native_unit_of_measurement=lambda entity: entity.device.get_outside_temp_unit(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        get_native_value=lambda entity: entity.device.get_av_shw_value(),
    ...
    AristonSensorEntityDescription(
        ...
        get_native_value=lambda entity: entity.device.get_gas_consumption_for_heating_last_month(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_electricity_consumption_for_heating_last_month(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_gas_consumption_for_water_last_month(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING, CustomDeviceFeatures.HAS_DHW],
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_electricity_consumption_for_water_last_month(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_central_heating_total_energy_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_domestic_hot_water_total_energy_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_central_heating_gas_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_domestic_hot_water_heating_pump_electricity_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_domestic_hot_water_resistor_electricity_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_domestic_hot_water_gas_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_central_heating_electricity_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_domestic_hot_water_electricity_consumption(),
        get_last_reset=lambda entity: entity.device.get_consumption_sequence_last_changed_utc(),
    ),
    AristonSensorEntityDescription(
        ...
        icon="mdi:timer",
        state_class=SensorStateClass.MEASUREMENT,
        get_native_value=lambda entity: entity.device.get_rm_tm_in_minutes(),
    ...
    AristonSensorEntityDescription(
        ...
        icon="mdi:chart-line",
        state_class=SensorStateClass.MEASUREMENT,
        get_native_value=lambda entity: entity.device.get_water_heater_heating_rate(),
        native_unit_of_measurement="",
        system_types=[SystemType.VELIS],
...
ARISTON_BINARY_SENSOR_TYPES: list[AristonBinarySensorEntityDescription] = (
    AristonBinarySensorEntityDescription(
        ...
        icon="mdi:fire",
        get_is_on=lambda entity: entity.device.get_is_flame_on_value(),
        system_types=[SystemType.GALEVO],
    ),
    AristonBinarySensorEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_is_heating_pump_on_value(),
        ...
        extra_states=[
            {
                ...
                EXTRA_STATE_DEVICE_METHOD: lambda entity: entity.device.get_holiday_expires_on(),
            }
        ],
        get_is_on=lambda entity: entity.device.get_holiday_mode_value(),
        system_types=[SystemType.GALEVO],
    ),
    AristonBinarySensorEntityDescription(
        ...
        icon="mdi:fire",
        get_is_on=lambda entity: entity.device.get_is_heating(),
        system_types=[SystemType.VELIS],
        whe_types=[WheType.Lux, WheType.Evo, WheType.Evo2, WheType.LydosHybrid],
    ),
)
...
ARISTON_SWITCH_TYPES: list[AristonSwitchEntityDescription] = (
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_automatic_thermoregulation(),
        system_types=[SystemType.GALEVO],
    ),
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_water_heater_eco_value(),
        system_types=[SystemType.VELIS],
        whe_types=[WheType.Lux, WheType.Evo, WheType.Evo2],
    ),
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_water_heater_power_value(),
        system_types=[SystemType.VELIS],
    ),
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_water_anti_leg_value(),
        system_types=[SystemType.VELIS],
    ),
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_water_heater_preheating_on_off(),
        system_types=[SystemType.VELIS],
        whe_types=[WheType.NuosSplit],
    ),
    AristonSwitchEntityDescription(
        ...
        get_is_on=lambda entity: entity.device.get_water_heater_boost(),
        system_types=[SystemType.VELIS],
        whe_types=[WheType.NuosSplit],
    ),
)
...
ARISTON_NUMBER_TYPES: list[AristonNumberEntityDescription] = (
    AristonNumberEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_elect_cost(),
    ...
    AristonNumberEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_native_value=lambda entity: entity.device.get_gas_cost(),
    ...
    AristonNumberEntityDescription(
        ...
        entity_category=EntityCategory.CONFIG,
        get_native_min_value=lambda entity: entity.device.get_water_heater_maximum_setpoint_temperature_minimum(),
        get_native_max_value=lambda entity: entity.device.get_water_heater_maximum_setpoint_temperature_maximum(),
        native_step=1,
        get_native_value=lambda entity: entity.device.get_water_heater_maximum_setpoint_temperature(),
    ...
    AristonNumberEntityDescription(
        ...
        entity_category=EntityCategory.CONFIG,
        get_native_min_value=lambda entity: entity.device.get_water_heater_minimum_setpoint_temperature_minimum(),
        get_native_max_value=lambda entity: entity.device.get_water_heater_minimum_setpoint_temperature_maximum(),
        native_step=1,
        get_native_value=lambda entity: entity.device.get_water_heater_minimum_setpoint_temperature(),
    ...
    AristonNumberEntityDescription(
        ...
        entity_category=EntityCategory.CONFIG,
        get_native_min_value=lambda entity: entity.device.get_water_heater_minimum_temperature(),
        get_native_max_value=lambda entity: entity.device.get_water_heater_maximum_temperature(),
        native_step=1,
        get_native_value=lambda entity: entity.device.get_water_heater_reduced_temperature(),
...
ARISTON_SELECT_TYPES: list[AristonSelectEntityDescription] = (
    AristonSelectEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_current_option=lambda entity: entity.device.get_currency(),
    ...
    AristonSelectEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_current_option=lambda entity: entity.device.get_gas_type(),
    ...
    AristonSelectEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING],
        coordinator=ENERGY_COORDINATOR,
        get_current_option=lambda entity: entity.device.get_gas_energy_unit(),
